...
export const convertWithFiles: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => void;
...
export const __wasm_bindgen_func_elem_342: (a: number, b: number, c: number, d: number) => void;
